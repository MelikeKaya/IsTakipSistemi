<%@ Page Title="" Language="C#" MasterPageFile="~/MstAna.Master" AutoEventWireup="true" CodeBehind="ziyaret_turleri.aspx.cs" Inherits="IsTakipSistemiWeb.ziyaret_turleri" %>
    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><span>Ziyaret Türleri</span></li>                    
            </ul>                   
        </div>        
        <br />        
        <div class="row">
                                ...
                                <div class="portlet light portlet-fit bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-red sbold uppercase">ZİYARET TÜRLERİ</span>
                                        </div>
                                        <div class="actions">
